...
/**
 * This implementation of a projection entity graph registry creates graphs only when requested and stores them in
 * memory thereafter for faster subsequent access.
 */
